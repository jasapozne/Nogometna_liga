...
CREATE TABLE zaposlen (
    emso INTEGER NOT NULL REFERENCES osebe(emso) PRIMARY KEY,
...
CREATE TABLE goli (
    id_tekme INTEGER REFERENCES tekma(id_tekme) PRIMARY KEY,
...
GRANT ALL ON DATABASE sem2022_jasap TO jasap WITH GRANT OPTION;
GRANT ALL ON SCHEMA public TO jasap WITH GRANT OPTION;
GRANT ALL ON ALL TABLES IN SCHEMA public TO jasap WITH GRANT OPTION;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO jasap WITH GRANT OPTION;
GRANT CONNECT ON DATABASE sem2022_jasap TO javnost;
...
GRANT ALL ON ALL TABLES IN SCHEMA public TO jasap WITH GRANT OPTION;
GRANT ALL ON ALL TABLES IN SCHEMA public TO zigag WITH GRANT OPTION;
GRANT ALL ON ALL TABLES IN SCHEMA public TO mykolash WITH GRANT OPTION;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO jasap WITH GRANT OPTION;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO zigag WITH GRANT OPTION;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO mykolash WITH GRANT OPTION;
